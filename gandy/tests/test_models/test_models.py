...
class TestUncertaintyModel(unittest.TestCase):
    ...
    def test_build(self):
        ...
        with mock.patch(
            ...
            self.assertTrue(subject.model is model) # ensure automatically set model
        return
    ...
    def test__build(self):
        ...
        # mock _build from here on out - we don;t want the init build to interfere
    ...
    def test_predict(self):
        ...
        _predict_return = [
            (['length', '2'], numpy.array([5, 10], dtype=int)), # expected to work
            ...
            ([['array', 'is'], ['2', 'dim']], [5, 10]) # failure yshape mismatch
        ]
        ...
        self.assertTrue(all([type(out) == numpy.ndarray for out in 
                             [preds, uncs, flags]]))
        ...
        self.assertTrue(numpy.array_equal(flags, np.array([[False],[True]])))
